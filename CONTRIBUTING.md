...
As the creators and maintainers of this project, we want to ensure that `codemod` lives and continues to grow and evolve. We would like to encourage everyone to help and support this library by contributing.

## Code contributions

Here is a quick guide to doing code contributions to the library.

1. Fork and clone the repo to your local machine `git clone https://github.com/YOUR_GITHUB_USERNAME/codemod.git`
...
9. Submit a pull request to the upstream codemod repository.
...
By contributing your code to the codemod GitHub repository, you agree to license your contribution under the MIT license.
